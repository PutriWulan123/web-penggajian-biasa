                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="text" name="periode"
                                            class="form-control"
                                            id="periode"
                                            value="{{ $row->periode }}" disabled>
                                    </div>
                                    <div class="mb-3">
                                      <label for="total_gaji"
                                          class="form-label">Total Gaji</label>
                                      <input type="number" name="total_gaji"
                                          class="form-control"
                                          id="total_gaji"
                                          value="{{ $row->total_gaji }}" disabled>
                                  </div>
                                  <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_bayar"
                                        class="form-control"
                                        id="tanggal_bayar"
                                        value="{{ $row->tanggal_bayar }}" disabled>
                                </div>
                                  </div>
                              </div>
                          </div>
